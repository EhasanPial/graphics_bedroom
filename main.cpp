   ...
   // glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE, 3 * sizeof(float), (void*)0);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		// bed 
		{
			...
			ourShader.setMat4("model", model);
			ourShader.setVec4("color", glm::vec4(0.8f, 0.2f, 0.2f, 1.0f));
			...
			model = translateMatrix * scaleMatrix;
			ourShader.setMat4("model", model);
			ourShader.setVec4("color", glm::vec4(1.0f, 0.99215f, 0.81568, 1.0f));
			glBindVertexArray(VAO);
			glDrawElements(GL_TRIANGLES, 36, GL_UNSIGNED_INT, 0);
...

		{
			...
			ourShader.setMat4("model", model);
			ourShader.setVec4("color", glm::vec4(0.2078f, 0.22353f, 0.2078f, 1.0f));
			glBindVertexArray(VAO);
			glDrawElements(GL_TRIANGLES, 36, GL_UNSIGNED_INT, 0);
			...
			model = translateMatrix * rotateYMatrix * scaleMatrix;
			ourShader.setMat4("model", model);
			ourShader.setVec4("color", glm::vec4(1.0, 0.749019f, 0.0, 1.0f));
			glDrawElements(GL_TRIANGLES, 36, GL_UNSIGNED_INT, 0);
		...
		// wardoff 1 
		{
			...
			translateMatrix = glm::translate(identityMatrix, glm::vec3(bx_chair, by_chair+.55f , bz_chair - 3.0f+0.5));
			...
			translateMatrix = glm::translate(identityMatrix, glm::vec3(bx_chair, by_chair + .175f, bz_chair - 3.0f + 0.75));
			...
			translateMatrix = glm::translate(identityMatrix, glm::vec3(bx_chair, by_chair + .175f *3  , bz_chair - 3.0f + 0.75));
			scaleMatrix = glm::scale(identityMatrix, glm::vec3(scale_X * 1.3f, scale_Y * .5f, scale_Z * 0.1));
			model = translateMatrix * scaleMatrix;
			ourShader.setMat4("model", model);
			ourShader.setVec4("color", glm::vec4(0.9235, 0.490, 0.1764, 1.0f));
			...
			translateMatrix = glm::translate(identityMatrix, glm::vec3(bx_chair, by_chair + .175f * 5 , bz_chair - 3.0f + 0.75));
			scaleMatrix = glm::scale(identityMatrix, glm::vec3(scale_X * 1.3f, scale_Y * .5f, scale_Z * 0.1));
			model = translateMatrix * scaleMatrix;
			ourShader.setMat4("model", model);
			ourShader.setVec4("color", glm::vec4(0.9235, 0.490, 0.1764, 1.0f));
		...
		/*	translateMatrix = glm::translate(identityMatrix, glm::vec3(bx_chair, by_chair, bz_chair));
			...
			model = translateMatrix * scaleMatrix;
			ourShader.setMat4("model", model);
			ourShader.setVec4("color", glm::vec4(0.62352f, 0.886274, 1.0f, 1.0f));
			glBindVertexArray(VAO);
			glDrawElements(GL_TRIANGLES, 36, GL_UNSIGNED_INT, 0);
			...
			model = translateMatrix * scaleMatrix;
			ourShader.setMat4("model", model);
			ourShader.setVec4("color", glm::vec4(0.9803, 0.9764, 0.964705, 1.0f));
			glBindVertexArray(VAO);
			glDrawElements(GL_TRIANGLES, 36, GL_UNSIGNED_INT, 0);
			...
			ourShader.setMat4("model", model);
			ourShader.setVec4("color", glm::vec4(0.50196, 0.0, 0.37647, 1.0f));
			glBindVertexArray(VAO);
			glDrawElements(GL_TRIANGLES, 36, GL_UNSIGNED_INT, 0);
